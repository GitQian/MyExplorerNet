...
//	const char *data = "userId=1287812&sign=f44782e8f9adfbc1ae12e70348d6034f";
...
/************* add by qiansheng start******************/
bool HttpPostModule::SetPostData(const char* strData)
{
